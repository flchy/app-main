  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" inline label-width="200px" size="mini">
      <el-form-item label="商品名称" prop="goodsName">
        <el-input v-model="form.goodsName" placeholder="商品名称" style="width:350px;" />
      </el-form-item>
      <el-form-item label="商品分类" prop="goodsClassifyId">
        <el-select v-model="form.goodsClassifyId" filterable placeholder="请选择商品分类" style="width:350px;">
          <el-option
